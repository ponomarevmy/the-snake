...
class Apple(GameObject):
    """Яблоко — игровой объект, появляющийся в случайной точке поля."""

    def __init__(self):
        """Создаёт яблоко в случайной позиции на игровом поле."""
        super().__init__()
...
class Snake(GameObject):
    """Змейка — основной управляемый игровой объект."""
    ...
    def update_direction(self):
        """Применяет направление движения, выбранное пользователем."""
